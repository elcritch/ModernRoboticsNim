...
func FKinSpace*[I: static[int], V](M: HomogenousMatrix[V], Slist: StaticMatrix[
  ...
  for col in Slist.asDynamic.reverseColumns:
    tmp = MatrixExp6((VecTose3((col * thetalist[i]).asStatic(
            6)))).asDynamic * tmp
    dec i

  result = tmp.asStatic(4, 4)

func JacobianBody*[I: static[int], V](Blist: StaticMatrix[6, I, V],
        thetalist: StaticVector[I, V]): StaticMatrix[6, I, V] =
...
func JacobianSpace*[I: static[int], V](Slist: StaticMatrix[6, I, V],
        thetalist: StaticVector[I, V]): StaticMatrix[6, I, V] =
